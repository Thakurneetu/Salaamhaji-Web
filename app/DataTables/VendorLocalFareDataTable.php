...
class VendorLocalFareDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        ->addColumn('action', function ($row) {
          return view('vendor_fares.local_fare.action', [
              'vendor_id' => $this->id,
              'id' => $row->id,
          ]);
        })
        ->editColumn('fare', function ($cab) {
          return $cab->vendor_local_fare->price;
        })
    ...
    {
      $userId = $this->id;
        return $model->newQuery()->whereHas('vendor_local_fare', function ($query) use ($userId) {

...
@section('content')
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('vendor-local-service.index')}}">Local Fare List</a></li>
  ...
  <div class="card card-success mx-3">
    <div class="card-header">
      ...
      <a href="{{ route('vendor-local-service.index') }}" class="btn btn-dark btn-sm float-right">Back</a>
    </div>

...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Manage Vendor Local Fare</h1>
        </div>
        <div class="col-sm-6">
  ...
  <div class="container-fluid">
    <div class="card mb-0">
      <div class="card-header">
        ...
        <a href="{{route('vendor-outstation-service.index')}}?id={{$vendor_id}}" class="btn btn-light" style=""><i class="fas fa-route"></i> Outstaion Fares</a>
        <a href="{{route('vendor-local-service.create')}}?id={{$vendor_id}}" class="btn btn-warning float-right" style=""><i class="fas fa-user-plus"></i> Add Local Fare</a>
      </div>
      <div class="card-body">
